...
class AchievementsMenuState extends MusicBeatState
{
	...
	override function create() {
		...
		for (i in 0...options.length) {
			...
			var optionText:Alphabet = new Alphabet(0, (100 * i) + 210, Achievements.isAchievementUnlocked(achieveName) ? Achievements.achievementsStuff[achievementIndex[i]][0] : '?', true, false);
