...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		notePlayerSkinInputText = new FlxUIInputText(noteSkinInputText.x, noteSkinInputText.y + 35, 150, _song.playerArrowSkin, 8);
		...
		var reloadNotesButton:FlxButton = new FlxButton(noteSplashesInputText.x + 200, noteSplashesInputText.y, 'Change Notes', function() {
		...
		tab_group_song.add(new FlxText(notePlayerSkinInputText.x, notePlayerSkinInputText.y - 15, 0, 'Player Note Texture:'));
	...
	override function update(elapsed:Float)
	{
		...
		if (!blockInput)
		{
			...
			if (FlxG.keys.justPressed.BACKSPACE) {
				//if(onMasterEditor) {
					MusicBeatState.switchAnimatedState(new editors.MasterEditorMenu());
