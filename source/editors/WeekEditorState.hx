...
class WeekEditorState extends MusicBeatState
{
	...
	function addEditorBox() {
		...
		var freeplayButton:FlxButton = new FlxButton(0, 650, "Freeplay", function() {
			MusicBeatState.switchAnimatedState(new WeekEditorFreeplayState(weekFile));
...
class WeekEditorFreeplayState extends MusicBeatState
{
	...
	function addEditorBox() {
		...
		var storyModeButton:FlxButton = new FlxButton(0, 685, "Story Mode", function() {
			MusicBeatState.switchAnimatedState(new WeekEditorState(weekFile));
	...
	override function update(elapsed:Float) {
		if(WeekEditorState.loadedWeek != null) {
			...
			MusicBeatState.switchAnimatedState(new WeekEditorFreeplayState(WeekEditorState.loadedWeek));
